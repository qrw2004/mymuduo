...
//TcpServer -> Acceptor -> 有一个新用户连接，通过accept函数拿到connfd -> TcpConnection设置回调 -> Channel -> Poller -> Channel的回调操作
...
private:
    ...
    const InetAddress localAddr_;//当前主机ip和端口号
    const InetAddress peerAddr_;//对端ip和端口号
